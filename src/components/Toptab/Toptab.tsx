...
//     this.state = {
//       currentNavtab: 0,
//       name: data.getCity ? data.geoCity.nm : '',
...
//     }
//   }
//   private switchTab(index: number,e: any) {
//     this.setState({
//       currentNavtab: index
//     })
//   }
...
//               <ScrollView scrollX style='height:160Px' className='expect' scrollTop={Number(0)} lowerThreshold={Number(10)} 
